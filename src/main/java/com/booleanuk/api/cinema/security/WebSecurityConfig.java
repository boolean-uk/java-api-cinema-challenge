    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers(HttpMethod.GET,"/movies/*/screenings").authenticated()

                        .requestMatchers(HttpMethod.GET,"/customers", "/customers/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT,"/customers", "/customers/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE,"/customers", "/customers/**").hasRole("ADMIN")

                        .requestMatchers(HttpMethod.POST,"/customers/*/screenings/*").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET,"/customers/*/screenings/*").authenticated()
                );
