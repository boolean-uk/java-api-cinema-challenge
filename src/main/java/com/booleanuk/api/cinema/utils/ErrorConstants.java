...
public class ErrorConstants {
    ...
    public static final String MOVIE_NOT_FOUND_MESSAGE = "Movie with id %s not found";
    public static final String TICKET_NOT_FOUND_MESSAGE = "Ticket with id %s not found";
    public static final String SCREENING_NOT_FOUND_MESSAGE = "Screening with id %s not found";
    ...
    public static final String NO_TICKET_FOR_SCREENING_MESSAGE = "No ticket found for the customer and screening with those ids";
