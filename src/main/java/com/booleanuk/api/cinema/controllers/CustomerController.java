...
public class CustomerController {
    ...
    public singleCustomerResponse createCustomer(@RequestBody CustomerDto requestCustomer) {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public singleTicketResponse bookATicket(@PathVariable Integer customerId, @PathVariable Integer screeningId, @RequestBody TicketDto ticket) {
